...
<body>
  <div id="container">
    <!-- Contenido HTML aquí -->
    <img id="ballImage" src="../imagenes/piña.jpg" alt="Imagen" width="300" height="200">
    <div id="dropZone"></div>
    <div>
      <div class="clickableElement" data-sound="sound4">Pi</div>
  ...
  <script>
    ...
    var randomSyllables = ['Pi', 'ña.','na']; // Sílabas aleatorias
...
function showErrorMessage(message) {
  ...
  setTimeout(function() {
    ...
    redirectButton.addEventListener('click', function() {
      window.location.href = 'puerta.php'; // Reemplaza con la URL de redirección correcta
    });
    function goBack() {
      window.history.back();
    }
