...
<body>
  <div id="container">
    <!-- Contenido HTML aquí -->
    <img id="ballImage" src="../imagenes/nube.jpg" alt="Imagen" width="300" height="200">
    <div id="dropZone"></div>
    <div>
      <div class="clickableElement" data-sound="sound4">Nu</div>
      <div class="clickableElement" data-sound="sound5">be.</div>
      <div class="clickableElement" data-sound="sound5">ve</div>
  ...
  <script>
    ...
    var randomSyllables = ['Nu', 'be.','ve']; // Sílabas aleatorias
...
function showErrorMessage(message) {
  ...
  setTimeout(function() {
    ...
    redirectButton.addEventListener('click', function() {
      window.location.href = 'pato.php'; // Reemplaza con la URL de redirección correcta
    });
    function goBack() {
      window.history.back();
    }
