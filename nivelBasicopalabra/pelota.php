  ...
  <style>
    ...
    #reloadButton {
     position: fixed;
      ...
      font-weight: bold;
      cursor: pointer;
      background-image: url('../imagenes/borrar.png');/* Ruta de la imagen para el botón de actualizar */
      background-repeat: no-repeat;
      background-position: center;
      background-size: contain;
    }
...
<body>
  ...
  <audio id="ballAudio" src="../sonidos/pelota.mp3" preload="auto"></audio>
  ...
  <script>
    ...
    //funcion para que los globos roten
    function randomizeBalloons() {
    var balloons = document.querySelectorAll('.balloon');
    balloons.forEach(function(balloon) {
      var randomDelay = Math.random() * 3 + 1; // Retraso aleatorio para la animación
      var randomDuration = Math.random() * 5 + 5; // Duración aleatoria para la animación
