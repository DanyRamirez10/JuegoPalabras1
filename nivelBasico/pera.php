...
<body>
  <div id="container">
    <!-- Contenido HTML aquí -->
    <img id="ballImage" src="../imagenes/pera.jpg" alt="Imagen" width="300" height="200">
    <div id="dropZone"></div>
    <div>
      <div class="clickableElement" data-sound="sound4">Pe</div>
      <div class="clickableElement" data-sound="sound5">ra.</div>
      <div class="clickableElement" data-sound="sound5">rra</div>
