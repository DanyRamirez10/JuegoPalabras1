...
<body>
  <div id="container">
    <!-- Contenido HTML aquí -->
    <img id="ballImage" src="../imagenes/piedra.png" alt="Imagen" width="300" height="200">
    <div id="dropZone"></div>
    <div>
      <div class="clickableElement" data-sound="sound4">Pie</div>
      <div class="clickableElement" data-sound="sound5">dra.</div>
      <div class="clickableElement" data-sound="sound5">da</div>
  ...
  <script>
    ...
    var randomSyllables = ['Pie', 'dra.','da']; // Sílabas aleatorias
