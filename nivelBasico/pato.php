...
<body>
  <div id="container">
    <!-- Contenido HTML aquí -->
    <img id="ballImage" src="../imagenes/pato.png" alt="Imagen" width="300" height="200">
    <div id="dropZone"></div>
    <div>
      <div class="clickableElement" data-sound="sound4">Pa</div>
      <div class="clickableElement" data-sound="sound5">to.</div>
      <div class="clickableElement" data-sound="sound5">ti</div>
  ...
  <script>
    ...
    var randomSyllables = ['Pa', 'to.','ti']; // Sílabas aleatorias
...
function showErrorMessage(message) {
  ...
  setTimeout(function() {
    ...
    redirectButton.addEventListener('click', function() {
      window.location.href = 'pera.php'; // Reemplaza con la URL de redirección correcta
    });
    function goBack() {
      window.history.back();
    }
